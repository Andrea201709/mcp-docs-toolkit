"""Confluence mock document adapter."""
...
_MOCK_FOLDERS = [
    {"id": "space-001", "name": "Engineering", "parentId": None},
    {"id": "space-002", "name": "Product", "parentId": None},
]

_MOCK_DOCUMENTS = [
    {"id": "page-001", "name": "Architecture Overview", "folderId": "space-001", "mimeType": "text/html", "size": 2048},
    {"id": "page-002", "name": "API Design Guide", "folderId": "space-001", "mimeType": "text/html", "size": 4096},
]

_MOCK_CONTENT = b"<h1>Architecture Overview</h1><p>Mock Confluence page content.</p>\n"


class ConfluenceMockDocAdapter:
